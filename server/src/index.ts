...
app.listen(port, () => {
  ...
  logger.info(`📚 API d'authentification: http://localhost:${port}/api/auth`)
  logger.info(`👤 API utilisateurs: http://localhost:${port}/api/users`)
  logger.info(`🛒 API produits: http://localhost:${port}/api/products`)
  logger.info(`💳 API checkout: http://localhost:${port}/api/checkout`)
  logger.info(`⭐ API avis: http://localhost:${port}/api/reviews`)
  logger.info(`🎟️ API codes promo: http://localhost:${port}/api/promo`)
  logger.info(`📦 API collection: http://localhost:${port}/api/collection`)
