...
function AppContent() {
  ...
  return (
    <div className={styles.appBg}>
      ...
      {/* Ancienne navbar masquée - remplacée par NavbarPremium */}
      {false && (
        <header className={`${styles.header} ${showHeader ? '' : styles.hidden}`} style={{ display: 'none' }}>
      ...
      <main className={styles.main}>
        <Routes>
          ...
          <Route path="/admin/products/:productId/edit" element={<AdminRoute><AdminProductFormPage /></AdminRoute>} />
          ...
          <Route path="/admin/promos/new" element={<AdminRoute><AdminPromoFormPage /></AdminRoute>} />
          <Route path="/admin/promos/:promoId/edit" element={<AdminRoute><AdminPromoFormPage /></AdminRoute>} />
