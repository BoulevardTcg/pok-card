...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const speed = isMobile ? 0.012 : 0.009; // x1.5
    const amplitude = isMobile ? 18 : 15; // + amplitude (x1.5)
    const amplitudeY = isMobile ? 15 : 12;
    const smoothing = isMobile ? 0.12 : 0.1; // lissage conservé
