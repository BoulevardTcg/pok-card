    ...
    <AdminLayout>
      ...
      <div className={styles.pageHeader}>
        <div className={styles.pageHeaderLeft}>
          <p className={styles.pageCount}>{products.length} produit{products.length > 1 ? 's' : ''} au total</p>
        </div>
              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  <tr key={product.id}>
                    ...
                    <td>
                      <span className={`${styles.stockBadge} ${isOutOfStock ? styles.outOfStock : isLowStock ? styles.lowStock : ''}`}>
                        {totalStock}
                      </span>
                    </td>
                    <td>
