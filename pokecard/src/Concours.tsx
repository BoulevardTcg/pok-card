    ...
    setTimeout(() => {
      ...
      if (selectedContest) {
        const updatedContest = {
          ...selectedContest,
          soldTickets: selectedContest.soldTickets + 1,
          participants: selectedContest.participants + 1,
        };
          ...
          >
            ...
            <div
              style={{
                ...
                height: '100%',
                background:
                  'linear-gradient(90deg, transparent, rgba(253, 224, 71, 0.1), transparent)',
            ...
            {pastContests.map((contest) => (
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: '1rem', fontWeight: '500' }}>{contest.prize}</div>
                </div>
      ...
      {showTicketModal && selectedContest && (
        ...
        >
          ...
          >
            ...
            >
              <div style={{ fontSize: '1.1rem', marginBottom: '8px' }}>{selectedContest.title}</div>
