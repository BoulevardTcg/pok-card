        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerSection}>
            ...
            <ul className={styles.footerLinkList}>
              <li>
                <button onClick={() => navigate('/')} className={styles.footerLink}>Accueil</button>
              </li>
              <li>
                <button onClick={() => navigate('/produits')} className={styles.footerLink}>Boutique</button>
              </li>
              <li>
                <button onClick={() => navigate('/cartes')} className={styles.footerLink}>Cartes</button>
              </li>
              <li>
